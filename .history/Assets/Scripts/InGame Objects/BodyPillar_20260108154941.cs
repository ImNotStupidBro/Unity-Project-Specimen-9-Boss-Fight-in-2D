...
public class BodyPillar : MonoBehaviour
{
    ...
    private void Rise()
    {
        ...
        foreach (SpriteRenderer sprite in sprites)
        {
            ...
            StartCoroutine(ExpandPillar(new Vector2(1.0f, 1.0f), 0.5f));
        }
    }
    private IEnumerator ExpandPillar(,Vector2 targetScale, float duration)
    {
        float elapsedTime = 0f;
        float expandDuration = duration; // Duration of the expansion effect
