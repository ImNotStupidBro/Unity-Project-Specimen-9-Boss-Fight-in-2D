...
public class BodyPillar : MonoBehaviour
{
    ...
    public IEnumerator SpawnBodyPillar()
    {
        dangerZoneInstance = Instantiate(
            ...
            Quaternion.identity);
        dangerZoneInstance.transform.localScale = new Vector3(1.5f, 1.0f, 1.0f);
        
        yield return new WaitForSeconds(waitDuration);Destroy(dangerZoneInstance, waitDuration);
        Rise();
