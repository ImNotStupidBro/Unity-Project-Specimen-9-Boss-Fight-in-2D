...
public class BodyPillar : MonoBehaviour
{
    ...
    public IEnumerator SpawnBodyPillar()
    {
        ...
        dangerZoneInstanceRenderer.drawMode = SpriteDrawMode.Tiled;
        dangerZoneInstanceRenderer.size = new Vector2(col.size.x, col.size.y);
        yield return new WaitForSeconds(waitDuration);
        Destroy(dangerZoneInstance, waitDuration);
        Rise();
